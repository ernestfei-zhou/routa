...
- Append a co-author line in the following format: (YourName, like Copilot,Augment,Claude etc.) (Your model name) <YourEmail, like, claude@anthropic.com, auggie@augmentcode.com)> for example (Just pick one):
