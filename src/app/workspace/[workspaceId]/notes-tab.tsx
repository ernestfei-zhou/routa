  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Workspace Notes</h2>
      ...
      {/* Notes list */}
      {loading ? (
        <div className="text-center py-8 text-slate-400 dark:text-slate-500 text-sm">Loading notes…</div>
            ...
            return (
              <div key={note.id} className="bg-white dark:bg-[#12141c] rounded-xl border border-slate-200/60 dark:border-[#1c1f2e] overflow-hidden hover:shadow-sm transition-shadow">
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <span className="px-1.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-500 shrink-0">Note</span>
                  {note.sessionId && (
